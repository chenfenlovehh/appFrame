...
public class PermissionUtils{
    ...
    /** 日历权限  */
    public static final String[] CALENDAR = {Manifest.permission.READ_CALENDAR, Manifest.permission.WRITE_CALENDAR};
     ...
     * @return
     */
    public static boolean checkStoragePermissions(@NonNull Context ctx) {
