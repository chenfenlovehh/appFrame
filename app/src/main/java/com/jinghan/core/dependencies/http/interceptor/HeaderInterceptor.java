...
public class HeaderInterceptor implements Interceptor{
    ...
    @Override public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        String opTime = sdf.format(c.getTime());
        builder.addHeader("op_time", opTime);
        builder.addHeader("channel_code", String.valueOf(AndroidUtils.getChannel(mContext)));//11位渠道号，或与老大厅相似的字母类型渠道（要提供渠道对应关系）
        ...
        builder.addHeader("client_ip", AndroidUtils.getHostIP());//客户端IP地址
        ...
        int value = r.nextInt(900000) + 100000;

        builder.addHeader("nonce_str", String.valueOf(value));//随机生成6位的数字字符串
